...
public class ProfilesTest {
    ...
    public void whenTestMethodCollectAgain() {
        ...
        Address fifth = new Address("New Urengoy", "Octyabrskaya", 12, 21);
        Address sixth = new Address("New Urengoy", "Truda", 17, 26);
        Address seventh = new Address("New Urengoy", "50 let USSR", 2, 12);
        List<Profile> profiles = Arrays.asList(
                new Profile(first),
                new Profile(second),
                new Profile(third),
